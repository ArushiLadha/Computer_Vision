//This calibration program uses RANSAC based approach using dlt to find basic solution from 6 random matches.
...
int main(){
   ...
   cout << endl<< "inliers --> "<<w*100<<"%"  <<endl <<endl;
   cout << "for best P attained --> "<<endl;
   proj_error(wld_pt, img_pt, best_P, npoint);
   inv_reproj_error(wld_pt, img_pt, best_P, npoint);
